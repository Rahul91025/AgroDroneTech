...
function ScientistAdvise() {
  return (
    <div>
       <div className="container mx-auto px-4 py-8 mt-16">
      <h2 className="text-4xl font-bold mb-12 text-center text-white">How to get Scientist Advise</h2>
      <div className="bg-white shadow-lg rounded-lg overflow-hidden  m-12">
        <div className="relative overflow-hidden border-2" style={{ paddingTop: '40.25%' }}>
          <iframe
...
export default ScientistAdvise
