...
import pic1 from '../../public/kisan-drone-new-4.jpg';
  ...
  return (
    <>
      ...
      <div className='relative flex flex-row items-start justify-center p-8 space-x-15 mb-[3rem]'>
        ...
        {/* Image Section */}
        <div className='flex-1 relative left-[12rem] z-[5] mt-[2rem]'>
          <img src={pic1} alt="Service" className='w-[30rem] h-[29rem] rounded-lg shadow-lg'/>
        </div>
