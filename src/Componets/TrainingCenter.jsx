...
const Product = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white p-2 shadow-sm mt-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* card left */}
        <div>
          <div className="overflow-hidden ">
            <div className="img-showcase flex transition-all duration-500">
              <img src="drone5.jpg" alt="drone" className="h-36 w-auto" />
              <img src="drone5.jpg" alt="drone" className="h-36 w-auto" />
              <img src="drone5.jpg" alt="drone" className="h-36 w-auto" />
              <img src="drone5.jpg" alt="drone" className="h-36 w-auto" />
            </div>
        ...
        <div className="p-4">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-600">
              {['Color: Black', 'Available: In stock', 'Category: Shoes', 'Shipping Area: All over the world', 'Shipping Fee: Free'].map((item, index) => (
                <li 
                  key={index} 
                  className={`flex items-center ${selectedOption === index ? 'bg-green-200' : ''}`}
                >
                  <label>
                    <input
                      type="radio"
          ...
          <div className="mb-6">
            <input type="number" min="0" defaultValue="1" className="border border-gray-300 rounded-full w-16 text-center p-2 mr-2" />
